...
public class Program3C_concurrent {
    public static void main(String[] args) {
        ...
        //сет Ани
        ConcurrentSkipListSet<Integer> a_set =new ConcurrentSkipListSet<>();
        //сет для пересечения = сет Ани
        ConcurrentSkipListSet<Integer> intersection_set =new ConcurrentSkipListSet<>();
        //читаем кубики Ани
        ...
        //сет Бори
        ConcurrentSkipListSet<Integer> b_set =new ConcurrentSkipListSet<>();
        //читаем кубики Бори
