...
public class Program5A {
    ...
    public static void bestPairOfClothes(int[] shirts,int[] pants,boolean wasSwap){
        int minDiff=Integer.MAX_VALUE; //минимальная разница в цвете - ее ищем

        int innerMin; //внутренняя разница. У кажой футболки она начнетется с нее и тех шорт на которых остановились. Внутренняя разница нужна для прохода по шортам
